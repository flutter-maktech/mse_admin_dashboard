                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      ElevatedButton.icon(
                        ...
                        onPressed: () {
                          Get.toNamed('/create-event', arguments: controller
                              .race.id);
                        },
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        Expanded(
                            flex: 3, child: Text('Channel', style: TextStyle(
                            color: AppColors.textBlack.withOpacity(0.7)))),
                        Expanded(
                            flex: 2, child: Text('Location', style: TextStyle(
                            color: AppColors.textBlack.withOpacity(0.7)))),
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Container(
                          padding: const EdgeInsets.symmetric(
                              horizontal: 24, vertical: 16),
                          color: isEven ? AppColors.rowGrey : AppColors
                              .rowWhite,
                          child: Row(
                            children: [
                              Expanded(flex: 3,
                                  child: Text(event.tvBroadcastChanel ?? 'N/A',
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Event ID: ${event.id}', style: const TextStyle(
                  fontSize: 12, color: AppColors.textBlack)),
              Text('Race ID: ${event.raceId}', style: const TextStyle(
                  fontSize: 12, color: AppColors.textBlack)),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('Delete Event', style: TextStyle(
                      color: AppColors.rowWhite, fontSize: 16)),
                ),
              ),
              ...
              SizedBox(
                ...
                child: OutlinedButton(
                  ...
                  child: const Text('Update Event', style: TextStyle(
